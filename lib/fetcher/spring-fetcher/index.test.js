...
jest.mock("../../utils/url-reader", function () {
    return {
...
describe('SpringFetcher', function () {
    var fetchEnvSpringParam;
    var springFetcher;
    beforeEach(function () {
        var parser = parser_1.parseJsonFormat;
        fetchEnvSpringParam = {
            serverUrl: 'http://localhost:9078',
            applicationName: 'user-service',
            profile: 'live'
        };
        springFetcher = new index_1.SpringFetcher(fetchEnvSpringParam, parser);
    });
    it('should fetch env file', function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, springFetcher.fetchConfigFromRemote()];
                case 1:
                    _a.sent();
                    result = springFetcher.parseToMapData();
